...
import LeftNavContentLayout, { type LeftNavItem } from "./components/settings/shared/LeftNavContentLayout";
import appIcon from "../../assets/icons/app-icon.png";
import { useNavigate } from "react-router-dom";
import MainContentWindow from "./components/shared/MainContentWindow";
...
export default function ChessPage() {
  ...
  const renderMainContent = (activeKey: string) => {
    ...
    if (activeKey !== "play") {
      return (
        <MainContentWindow className="chess-main-placeholder" ariaLabel={`${activeKey} section`}>
    ...
    return (
      <MainContentWindow ariaLabel="Play section">
        <Chess
          showMoveList
          orientation="white"
          allowUndo
  ...
  return (
    <div className="chess-page-shell chess-page-shell--layout">
      <LeftNavContentLayout
        ...
        navAriaLabel="Chess sections"
        className="chess-main-layout"
        ...
        navFooter={
          <div className="chess-main-layout__footer">
            ...
            {isAuthenticated ? (
              <button type="button" className="chess-main-layout__auth-btn" onClick={handleLogout}>
                Log Out
              </button>
            ) : (
              <div className="chess-main-layout__auth-row">
                <button type="button" className="chess-main-layout__auth-btn" onClick={() => navigate("/register")}>
                  Sign Up
                </button>
                <button type="button" className="chess-main-layout__auth-btn chess-main-layout__auth-btn--secondary" onClick={() => navigate("/login")}>
                  Log In
                </button>
              </div>
            )}
